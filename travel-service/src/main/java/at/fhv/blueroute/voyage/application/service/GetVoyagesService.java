...
public class GetVoyagesService {
    ...
    private VoyageResponse mapToResponse(Voyage v, int currentTick) {
        ...
        dto.pendingEventType = v.getPendingEventType();
        dto.eventTriggerTick = v.getEventTriggerTick();
        dto.eventTriggered = v.isEventTriggered();
        dto.eventResolved = v.isEventResolved();
