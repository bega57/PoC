...
public class ResolveVoyageEventRequest {
    ...
    public VoyageEventOption getSelectedOption() { return selectedOption; }
    public void setSelectedOption(VoyageEventOption selectedOption) { this.selectedOption = selectedOption; }
}