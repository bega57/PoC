...
public class ShipService {
    ...
    public ShipResponse buyShip(BuyShipRequest request) {
        ...
        PlayerResponse playerFromService = playerServiceClient.getPlayer(request.getPlayerId());
        ...
        boolean hasCompanyName = playerFromService.getCompanyName() != null
                && !playerFromService.getCompanyName().isBlank();
        ...
        ship.setCurrentPort(playerFromService.getCurrentPort());
